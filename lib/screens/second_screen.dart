...
import 'package:mocktest/models/apicall.dart';
...
Widget customListView(List<Topic> list, BuildContext context) {
  return ListView.builder(
    ...
    itemBuilder: (context, index) {
      bool isTopicNameSelected = false;
          ...
          children: [
            Row(
              children: [
                Checkbox(
                    ...
                    value: isTopicNameSelected,
                    onChanged: (_) {
                      setState(() {
                        isTopicNameSelected
                            ? isTopicNameSelected = false
                            : isTopicNameSelected = true;
                      });
                    }),
                FittedBox(
                    child: Text(
            ...
            Visibility(
              ...
              child: SizedBox(
                  ...
                  child: moreTopicListView(list[index].topics, context)),
            )
          ],
        );
      });
